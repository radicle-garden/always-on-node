...
export function getConfig(): AppConfig {
	return {
		...
		public: {
			defaultHttpdApiHostname: process.env.DEFAULT_HTTPD_API_HOSTNAME || configJson.public.defaultHttpdApiHostname,
			defaultHttpdApiPort: Number(process.env.DEFAULT_HTTPD_API_PORT) || configJson.public.defaultHttpdApiPort,
			defaultHttpdApiScheme: process.env.DEFAULT_HTTPD_API_SCHEME || configJson.public.defaultHttpdApiScheme
		}
	};
}
